...
function App() {
  ...
  // const[acess,setAcess]=useState(JSON.parse(localStorage.getItem('trendytoken')));
  // console.log(loggeduser)
  // useEffect(()=>{
  //    if(localStorage.getItem('trendyemail')!==null){
  //      setLoggeduser(JSON.parse(localStorage.getItem('trendyemail')))
  //    }
