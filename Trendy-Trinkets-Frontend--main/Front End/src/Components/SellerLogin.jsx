...
export default function SellerLogin()
{
  ...
  return (
    ...
    //       </div> 
    //         <input type="email" className="s-inp" required placeholder="Email" onChange={handleInput} name="customerEmailId" value={userCreds.email}/>
    //         <input type="password" className="s-inp" required placeholder="Password" onChange={handleInput} name="password" value={userCreds.password}/>
